...
INSERT IGNORE INTO usuarios (nombre, email, contrasena, tipo) 
VALUES ('Administrador', 'admin@mediateca.com', 'admin123', 'ADMIN');

-- Insertar profesor de prueba
INSERT IGNORE INTO usuarios (nombre, email, contrasena, tipo, carrera) 
VALUES ('Carlos Pérez', 'carlos@mediateca.com', 'prof123', 'PROFESOR', 'Ingeniería');

-- Insertar alumno de prueba
INSERT IGNORE INTO usuarios (nombre, email, contrasena, tipo, carrera) 
VALUES ('Ana Gómez', 'ana@mediateca.com', 'alum123', 'ALUMNO', 'Medicina');
...
-- Insertar préstamos de prueba (activos y vencidos)
INSERT IGNORE INTO prestamos (id_usuario, id_material, fecha_prestamo, fecha_devolucion_esperada, estado) 
VALUES 
(1, 1, '2026-05-01', '2026-04-30', 'ACTIVO'),  -- Préstamo vencido (7 días)
(2, 2, '2026-05-01', '2026-05-15', 'ACTIVO'),  -- Préstamo vigente
(3, 3, '2026-04-01', '2026-04-15', 'ACTIVO'); -- Préstamo muy vencido (22 días)
...
-- ------------------------------------------------------
-- PRUEBA 1: Verificar usuarios creados
-- ------------------------------------------------------
SELECT 'PRUEBA 1: Verificar usuarios' AS 'Prueba';
SELECT COUNT(*) AS 'Cantidad de usuarios (esperado >= 3)' FROM usuarios;

-- ------------------------------------------------------
-- PRUEBA 2: Verificar materiales creados
-- ------------------------------------------------------
SELECT 'PRUEBA 2: Verificar materiales' AS 'Prueba';
SELECT COUNT(*) AS 'Cantidad de materiales (esperado >= 5)' FROM material;
...
-- ------------------------------------------------------
-- PRUEBA 4: Verificar préstamos activos
-- ------------------------------------------------------
SELECT 'PRUEBA 4: Verificar préstamos activos' AS 'Prueba';
SELECT COUNT(*) AS 'Cantidad de préstamos activos (esperado >= 2)' 
FROM prestamos WHERE estado = 'ACTIVO';

-- ------------------------------------------------------
-- PRUEBA 5: Calcular días de retraso (mora)
-- ------------------------------------------------------
SELECT 'PRUEBA 5: Calcular días de retraso (préstamos vencidos)' AS 'Prueba';
SELECT 
    p.id_prestamo,
    u.nombre AS 'Usuario',
...
-- ------------------------------------------------------
-- PRUEBA 6: Calcular mora según configuración (préstamo más antiguo)
-- ------------------------------------------------------
SELECT 'PRUEBA 6: Calcular mora para préstamo más antiguo' AS 'Prueba';
SELECT 
    p.id_prestamo,
    u.nombre AS 'Usuario',
    m.titulo AS 'Material',
...
-- ------------------------------------------------------
-- PRUEBA 7: Verificar límite de préstamos por usuario
-- ------------------------------------------------------
SELECT 'PRUEBA 7: Préstamos activos por usuario' AS 'Prueba';
SELECT 
    u.id_usuario,
    u.nombre,
    u.tipo,
...
-- ------------------------------------------------------
-- PRUEBA 8: Verificar tipos de usuarios y sus privilegios
-- ------------------------------------------------------
SELECT 'PRUEBA 8: Distribución de usuarios por tipo' AS 'Prueba';
SELECT 
    tipo,
    COUNT(*) AS 'Cantidad'
FROM usuarios
...
-- ------------------------------------------------------
-- PRUEBA 9: Verificar logs (debe estar vacío inicialmente)
-- ------------------------------------------------------
SELECT 'PRUEBA 9: Verificar tabla de logs' AS 'Prueba';
SELECT COUNT(*) AS 'Cantidad de logs (esperado 0 si no hay errores)' FROM logs_errores;

-- ------------------------------------------------------
-- PRUEBA 10: Resumen completo del sistema
-- ------------------------------------------------------
SELECT '========================================' AS '';
